...
public class NumberCruncherServer extends UnicastRemoteObject implements NumberCruncher {
    ...
    @Override
    public int[] factor(final int number) throws RemoteException {
        // The client's host is an important source of information.
        try {
            MDC.put("client", RemoteServer.getClientHost());
        } catch (final java.rmi.server.ServerNotActiveException e) {
