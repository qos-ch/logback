...
public class FileAppender<E> extends OutputStreamAppender<E> {
	...
	public void stop() {
		...
		final Map<String, String> map = ContextUtil.getFilenameCollisionMap(context);
	...
	protected boolean checkForFileCollisionInPreviousFileAppenders() {
		...
		for (final Entry<String, String> entry : previousFilesMap.entrySet()) {
	...
	public void openFile(final String file_name) throws IOException {
		...
		try {
			...
			final ResilientFileOutputStream resilientFos = new ResilientFileOutputStream(file, append, bufferSize.getSize());
	...
	private void safeWrite(final E event) throws IOException {
		final ResilientFileOutputStream resilientFOS = (ResilientFileOutputStream) getOutputStream();
