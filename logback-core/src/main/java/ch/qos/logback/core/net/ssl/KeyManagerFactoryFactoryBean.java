 ...
 * <p>
 * This object holds the configurable properties of a key manager factory and
 * uses them to create and load a {@link KeyManagerFactory} instance.
 *
 * @author Carl Harris
 */
public class KeyManagerFactoryFactoryBean {
    ...
    public KeyManagerFactory createKeyManagerFactory() throws NoSuchProviderException, NoSuchAlgorithmException {
        ...
        return getProvider() != null ? KeyManagerFactory.getInstance(getAlgorithm(), getProvider())
     ...
     *         (obtained from {@link KeyManagerFactory#getDefaultAlgorithm()}) is
     *         returned if no algorithm has been configured
     */
     ...
     * 
     * @param provider name of the JSSE provider to utilize in creating the key
     *                 manager factory
     */
