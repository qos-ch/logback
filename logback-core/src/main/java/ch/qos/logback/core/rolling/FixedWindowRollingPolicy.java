...
public class FixedWindowRollingPolicy extends RollingPolicyBase {
    ...
    public void start() {
        ...
        final IntegerTokenConverter itc = fileNamePattern.getIntegerTokenConverter();
        ...
        if (compressionMode == CompressionMode.ZIP) {
            final String zipEntryFileNamePatternStr = transformFileNamePatternFromInt2Date(fileNamePatternStr);
    ...
    public void rollover() throws RolloverFailure {
        ...
        if (maxIndex >= 0) {
            ...
            final File file = new File(fileNamePattern.convertInt(maxIndex));
            ...
            for (int i = maxIndex - 1; i >= minIndex; i--) {
                final String toRenameStr = fileNamePattern.convertInt(i);
