...
public class SpacePadder {
	...
	final static public void rightPad(final StringBuilder buf, final String s, final int desiredLength) {
		int actualLen = 0;
		if (s != null) {
			actualLen = s.length();
		}
	 ...
	 */
	final static public void spacePad(final StringBuilder sbuf, int length) {
		while (length >= 32) {
