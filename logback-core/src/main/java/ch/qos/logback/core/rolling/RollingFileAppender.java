...
public class RollingFileAppender<E> extends FileAppender<E> {
    ...
    private boolean checkForCollisionsInPreviousRollingFileAppenders() {
        ...
        if (triggeringPolicy instanceof RollingPolicyBase) {
            final RollingPolicyBase base = (RollingPolicyBase) triggeringPolicy;
            final FileNamePattern fileNamePattern = base.fileNamePattern;
            final boolean collisionsDetected = innerCheckForFileNamePatternCollisionInPreviousRFA(fileNamePattern);
    ...
    private boolean innerCheckForFileNamePatternCollisionInPreviousRFA(final FileNamePattern fileNamePattern) {
        boolean collisionsDetected = false;
        @SuppressWarnings("unchecked")
        final Map<String, FileNamePattern> map = (Map<String, FileNamePattern>) context.getObject(CoreConstants.RFA_FILENAME_PATTERN_COLLISION_MAP);
        if (map == null) {
            return collisionsDetected;
        }
        for (final Entry<String, FileNamePattern> entry : map.entrySet()) {
    ...
    public void stop() {
        ...
        final Map<String, FileNamePattern> map = ContextUtil.getFilenamePatternCollisionMap(context);
    ...
    private void attemptRollover() {
        ...
        } catch (final RolloverFailure rf) {
