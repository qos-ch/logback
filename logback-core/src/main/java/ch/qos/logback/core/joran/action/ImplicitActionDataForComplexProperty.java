 ...
 * @author Ceki
 */
public class ImplicitActionDataForComplexProperty {
    ...
    public ImplicitActionDataForComplexProperty(PropertySetter parentBean, AggregationType aggregationType, String complexPropertyName) {
