...
public class FileStoreUtil {
     ...
     */
    static public boolean areOnSameFileStore(final File a, final File b) throws RolloverFailure {
        if (!a.exists()) {
        ...
        try {
            final Path pathA = a.toPath();
            final Path pathB = b.toPath();

            final FileStore fileStoreA = Files.getFileStore(pathA);
            final FileStore fileStoreB = Files.getFileStore(pathB);
