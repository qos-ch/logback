...
public class BeanUtil {
     ...
     * The given string with underscores instead of dashes if the first two consecutive letters are in upper case.
     * The given string with underscores instead of dashes and the first letter in lower case.
     */
