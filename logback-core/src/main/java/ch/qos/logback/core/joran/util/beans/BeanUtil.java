...
public class BeanUtil {
     ...
     */
    static public boolean isAdder(final Method method) {
    ...
    static private int getParameterCount(final Method method) {
     ...
     */
    static public String getPropertyName(final Method method) {
        final String methodName = method.getName();
     ...
     */
    static public String toLowerCamelCase(final String string) {
        if (string == null) {
            return null;
        }
    ...
    static private String getSubstringIfPrefixMatches(final String wholeString, final String prefix) {
