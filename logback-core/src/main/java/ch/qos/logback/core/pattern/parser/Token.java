...
class Token {
    ...
    public Token(final int type, final List<String> optionsList) {
        this(type, null, optionsList);
    }

    public Token(final int type, final String value, final List<String> optionsList) {
        this.type = type;
        this.value = value;
    ...
    public int hashCode() {
        int result;
        result = type;
        return 29 * result + (value != null ? value.hashCode() : 0);
    }
