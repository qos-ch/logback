...
public class ConsoleAppender<E> extends OutputStreamAppender<E> {
	...
	private OutputStream wrapWithJansi(final OutputStream targetStream) {
		try {
			...
			final Class<?> classObj = classLoader.loadClass(AnsiConsole_CLASS_NAME);
			final String methodName = target == ConsoleTarget.SystemOut ? wrapSystemOut_METHOD_NAME : wrapSystemErr_METHOD_NAME;
			final Method method = classObj.getMethod(methodName, ARGUMENT_TYPES);
