...
public class ServerSocketUtil {
	 ...
	 * @throws IOException
	 */
	public static ServerSocket createServerSocket(final ServerSocketFactory socketFactory) throws IOException {
		ServerSocket socket = null;
		int retries = 10;
		while (retries-- > 0 && socket == null) {
			final int port = (int) ((65536 - 1024) * Math.random()) + 1024;
			try {
