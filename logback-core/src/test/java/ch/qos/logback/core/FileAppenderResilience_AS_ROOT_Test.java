...
public class FileAppenderResilience_AS_ROOT_Test {
    ...
    public void setUp() throws IOException, InterruptedException {
        ...
        final Process p = runLoopFSScript(LoopFSCommand.setup);
        p.waitFor();
    ...
    void dump(final String file) throws IOException {
    ...
    public void tearDown() throws IOException, InterruptedException {
        ...
        fa.stop();
        final Process p = runLoopFSScript(LoopFSCommand.teardown);
        p.waitFor();
    ...
    public void go() throws IOException, InterruptedException {
        ...
        final Process p = runLoopFSScript(LoopFSCommand.shake);
    ...
    Process runLoopFSScript(final LoopFSCommand cmd) throws IOException, InterruptedException {
