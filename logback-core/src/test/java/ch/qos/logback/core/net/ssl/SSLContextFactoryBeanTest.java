...
public class SSLContextFactoryBeanTest {
    ...
    private final MockKeyManagerFactoryFactoryBean keyManagerFactory = new MockKeyManagerFactoryFactoryBean();

    private final MockTrustManagerFactoryFactoryBean trustManagerFactory = new MockTrustManagerFactoryFactoryBean();

    private final MockKeyStoreFactoryBean keyStore = new MockKeyStoreFactoryBean();

    private final MockKeyStoreFactoryBean trustStore = new MockKeyStoreFactoryBean();

    private final MockSecureRandomFactoryBean secureRandom = new MockSecureRandomFactoryBean();
