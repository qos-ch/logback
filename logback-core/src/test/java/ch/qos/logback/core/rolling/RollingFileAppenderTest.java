...
public class RollingFileAppenderTest extends AbstractAppenderTest<Object> {
    ...
    public void testFilePropertyAfterRollingPolicy() {
        ...
        final StatusChecker statusChecker = new StatusChecker(context.getStatusManager());
    ...
    public void stopFixedWindowRollingPolicy() {
        ...
        final SizeBasedTriggeringPolicy<Object> sbTriggeringPolicy = new SizeBasedTriggeringPolicy<>();
    ...
    public void testFileShouldNotMatchFileNamePattern() {
        ...
        final boolean containsMatch = statusChecker.containsMatch(Status.ERROR, msg);
    ...
    public void collidingFileNamePattern() {
        final String filenamePattern = CoreTestConstants.OUTPUT_DIR_PREFIX + diff + "-collision-%d.log.zip";

        final RollingFileAppender<Object> appender0 = new RollingFileAppender<>();
        appender0.setName("FA0");
        appender0.setContext(context);
        appender0.setEncoder(new DummyEncoder<>());
        final TimeBasedRollingPolicy<Object> tbrp0 = new TimeBasedRollingPolicy<>();
        ...
        final RollingFileAppender<Object> appender1 = new RollingFileAppender<>();
        appender1.setName("FA1");
        appender1.setFile("X");
        appender1.setContext(context);
        appender1.setEncoder(new DummyEncoder<>());
        final TimeBasedRollingPolicy<Object> tbrp1 = new TimeBasedRollingPolicy<>();
