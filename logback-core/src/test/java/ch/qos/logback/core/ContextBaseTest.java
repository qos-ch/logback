...
public class ContextBaseTest {
    ...
    private final InstrumentedLifeCycleManager lifeCycleManager = new InstrumentedLifeCycleManager();

    private final InstrumentedContextBase context = new InstrumentedContextBase(lifeCycleManager);
    ...
    private static class InstrumentedContextBase extends ContextBase {
        ...
        public InstrumentedContextBase(final LifeCycleManager lifeCycleManager) {
    ...
    public void contextThreadpoolIsDaemonized() throws InterruptedException {
        final ExecutorService execSvc = context.getExecutorService();
