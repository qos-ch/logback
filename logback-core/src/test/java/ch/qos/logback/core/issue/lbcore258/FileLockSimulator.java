...
public class FileLockSimulator {
    ...
    static void lockAndWrite(final int i) throws InterruptedException, IOException {
        ...
        try {
            ...
            final String msg = "hello from" + instanceName + " " + i + LINE_SEPARATOR;
    ...
    static void printDotAndSleep(final int i) throws InterruptedException {
        if (i % DOT_FREQ == 0) {
            System.out.print(".");
            Thread.sleep(delay);
        }
