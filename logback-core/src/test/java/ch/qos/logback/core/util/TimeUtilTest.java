...
public class TimeUtilTest {
    ...
    public void testSecond() {
        ...
        final long now = 1164042317522L;
        // Mon Nov 20 18:05:18,000 CET 2006
        final long expected = 1164042318000L;
        final long computed = TimeUtil.computeStartOfNextSecond(now);
    ...
    public void testMinute() {
        ...
        final long expected = 1164042360000L;

        final long computed = TimeUtil.computeStartOfNextMinute(now);
    ...
    public void testHour() {
        ...
        final long computed = TimeUtil.computeStartOfNextHour(now);
    ...
    public void testDay() {
        ...
        expected = correctBasedOnTimeZone(expected);
        final long computed = TimeUtil.computeStartOfNextDay(now);
    ...
    public void testWeek() {
        ...
        final int dayOffset = cal.getFirstDayOfWeek() - Calendar.SUNDAY;
        if (dayOffset != 0) {
            expected += 24L * 3600 * 1000 * (cal.getFirstDayOfWeek() - Calendar.SUNDAY);
        }

        final long computed = TimeUtil.computeStartOfNextWeek(now);
    ...
    public void testMonth() {
        ...
        final long computed = TimeUtil.computeStartOfNextMonth(now);
        assertEquals(expected - now, 1000 * (3600 * (5 + 24 * 10) + 60 * 54 + 42) + 478);
        assertEquals(expected, computed);
    }

    private long correctBasedOnTimeZone(final long gmtLong) {
