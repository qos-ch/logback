...
public class LBCORE97 {
    ...
    public static void execute(final String text, final Thread[] threads) throws InterruptedException {
    ...
    public static void print(final String text, final Runnable[] runnables) {
    ...
    public static void usingSynchronized(final int threadCount) throws InterruptedException {
        final Object lockObject = new Object();
        final Runnable[] runnables = new Runnable[threadCount];
        ...
        final String text = "usingSynchronized";
        execute(text, threads);
        print(text, runnables);
    }

    public static void usingUnfairLock(final int threadCount) throws InterruptedException {
        ...
        final String text = "usingUnfairLock";
        execute(text, threads);
        print(text, runnables);
    }

    public static void usingFairLock(final int threadCount) throws InterruptedException {
        ...
        final String text = "usingFairLock";
        execute(text, threads);
        print(text, runnables);
    }
    ...
    public static class SynchronizedRunnable implements Runnable {
        ...
        public SynchronizedRunnable(final Object lockObject) {
    ...
    public static class LockRunnable implements Runnable {
        ...
        public LockRunnable(final Lock lock) {
            this.lock = lock;
            counter = 0;
            running = false;
        }
