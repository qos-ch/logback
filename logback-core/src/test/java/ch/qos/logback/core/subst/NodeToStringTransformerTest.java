...
public class NodeToStringTransformerTest {
	...
	private Node makeNode(final String input) throws ScanException {
	...
	public void literal() throws ScanException {
		final String input = "abv";
		final Node node = makeNode(input);
		final NodeToStringTransformer nodeToStringTransformer = new NodeToStringTransformer(node, propertyContainer0);
		assertEquals(input, nodeToStringTransformer.transform());
	}

	void checkInputEqualsOutput(final String input) throws ScanException {
		final Node node = makeNode(input);
		final NodeToStringTransformer nodeToStringTransformer = new NodeToStringTransformer(node, propertyContainer0);
		assertEquals(input, nodeToStringTransformer.transform());
	}
	...
	public void LOGBACK729() throws ScanException {
		final String input = "${${k0}.jdbc.url}";
		final Node node = makeNode(input);
		final NodeToStringTransformer nodeToStringTransformer = new NodeToStringTransformer(node, propertyContainer0);
	...
	public void LOGBACK744_withColon() throws ScanException {
		final String input = "%d{HH:mm:ss.SSS} host:${host} %logger{36} - %msg%n";
		final Node node = makeNode(input);
		final NodeToStringTransformer nodeToStringTransformer = new NodeToStringTransformer(node, propertyContainer0);
	...
	public void loneColonShouldReadLikeAnyOtherCharacter() throws ScanException {
		final String input = "java:comp/env/jdbc/datasource";
		final Node node = makeNode(input);
		final NodeToStringTransformer nodeToStringTransformer = new NodeToStringTransformer(node, propertyContainer0);
		assertEquals(input, nodeToStringTransformer.transform());
	}
	...
	public void defaultValueNestedAsVar() throws ScanException {
		final String input = "a${k67:-x${k0}}c";
		final Node node = makeNode(input);
		final NodeToStringTransformer nodeToStringTransformer = new NodeToStringTransformer(node, propertyContainer0);
