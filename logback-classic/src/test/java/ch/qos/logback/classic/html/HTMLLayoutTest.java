...
public class HTMLLayoutTest {
    ...
    public void testPresentationHeader() throws Exception {
        final StringBuilder header = new StringBuilder().append(layout.getFileHeader());
    ...
    public void testDoLayout() throws Exception {
        ...
        final StringBuilder result = new StringBuilder().append(layout.getFileHeader());
    ...
    public void layoutWithException() throws Exception {
        ...
        final StringBuilder stringToParse = new StringBuilder().append(layout.getFileHeader());
