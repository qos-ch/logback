...
public class Checker {
	...
	static void check(final String stamp, final String filename, final boolean safetyMode) throws Exception {

		try (FileReader fr = new FileReader(FILENAME); BufferedReader br = new BufferedReader(fr)) {

			final String regExp = "^" + stamp + " DEBUG - " + LoggingThread.msgLong + " (\\d+)$";
