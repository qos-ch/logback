...
public class SQLBuilderTest {
    ...
    public void shouldReturnDefaultSqlInsertLoggingEventQuery() throws Exception {
        // given
        final DBNameResolver nameResolver = new DefaultDBNameResolver();

        // when
        final String sql = SQLBuilder.buildInsertSQL(nameResolver);
    ...
    public void shouldReturnDefaultSqlInsertExceptionQuery() throws Exception {
        ...
        // when
        final String sql = SQLBuilder.buildInsertExceptionSQL(nameResolver);
    ...
    public void shouldReturnDefaultSqlInsertLoggingPropertyQuery() throws Exception {
        ...
        // when
        final String sql = SQLBuilder.buildInsertPropertiesSQL(nameResolver);
    ...
    public void shouldReturnSimpleSqlInsertLoggingEventQuery() throws Exception {
        // given
        final DBNameResolver nameResolver = createSimpleDBNameResolver();
