...
public class SyslogAppenderTest {
	...
	public void setMockServerAndConfigure(final int expectedCount, final String suffixPattern) throws InterruptedException {
	...
	public void setMockServerAndConfigure(final int expectedCount) throws InterruptedException {
	...
	public void basic() throws InterruptedException {
		...
		final String msg = new String(mockServer.getMessageList().get(0));

		final String threadName = Thread.currentThread().getName();

		final String expected = "<" + (SyslogConstants.LOG_MAIL + SyslogConstants.DEBUG_SEVERITY) + ">";
	...
	public void tException() throws InterruptedException {
		...
		final String logMsg = "hello";
		final String exMsg = "just testing";
	...
	private void checkRegexMatch(final String s, final String regex) {
	...
	public void large() throws Exception {
		...
		final StringBuilder largeBuf = new StringBuilder();
		...
		assertTrue(msg.startsWith(expected));
		final String regex = SYSLOG_PREFIX_REGEX + "\\[" + threadName + "\\] " + loggerName + " " + logMsg;
		checkRegexMatch(msg, regex);
	}
	...
	public void nonAsciiMessageEncoding() throws Exception {
		...
		final String logMsg = "R\u0129ga"; // Riga spelled with the i having a tilda on top

		final Charset ISO_8859_4 = Charset.forName("ISO-8859-4");
		...
		assertTrue(mockServer.isFinished());
		assertEquals(1, mockServer.getMessageList().size());
		final String msg = new String(mockServer.getMessageList().get(0), ISO_8859_4);
		final String threadName = Thread.currentThread().getName();
