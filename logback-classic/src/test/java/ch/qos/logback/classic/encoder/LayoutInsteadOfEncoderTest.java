...
public class LayoutInsteadOfEncoderTest {
    ...
    public void layoutInsteadOfEncoer() throws JoranException {
        ...
        ch.qos.logback.classic.Logger root = (ch.qos.logback.classic.Logger) loggerContext
    ...
    public void immediateFlushInEncoder(Boolean immediateFlush) throws JoranException {
        ...
        checker.assertContainsMatch(Status.WARN,
                "Please move \"immediateFlush\" property into the enclosing appender.");
        checker.assertContainsMatch(Status.WARN,
                "Setting the \"immediateFlush\" property of the enclosing appender to " + immediateFlush);
