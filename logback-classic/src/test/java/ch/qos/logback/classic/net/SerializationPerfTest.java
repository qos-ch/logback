...
public class SerializationPerfTest extends TestCase {
    ...
    public void runPerfTest(final Builder<?> builder, final String label) throws Exception {
    ...
    public void testWithMinimalSerialization() throws Exception {
        final Builder<MinimalSer> builder = new MinimalSerBuilder();
    ...
    public void testWithSerialization() throws Exception {
        final Builder<LoggingEventVO> builder = new TrivialLoggingEventVOBuilder();
