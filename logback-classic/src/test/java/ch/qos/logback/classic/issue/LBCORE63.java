...
public class LBCORE63 extends Thread {
    ...
    @Override
    public void start() {
        final ScheduledThreadPoolExecutor ex1 = new ScheduledThreadPoolExecutor(1);
        final ScheduledThreadPoolExecutor ex2 = new ScheduledThreadPoolExecutor(1);
        final ScheduledThreadPoolExecutor ex3 = new ScheduledThreadPoolExecutor(1);
        final ScheduledThreadPoolExecutor ex4 = new ScheduledThreadPoolExecutor(1);
        final ScheduledThreadPoolExecutor ex5 = new ScheduledThreadPoolExecutor(1);
    ...
    public static void main(final String[] args) {
        try {
            final LBCORE63 main = new LBCORE63();
            main.start();
