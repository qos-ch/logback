...
public class RandomUtil {
     ...
     * @return
     */
    static public int gaussianAsPositiveInt(final Random random, final int average, final int stdDeviation) {
        if (average < 1) {
        ...
        final double d = random.nextGaussian() * stdDeviation + average;
        int result = 1;
        if (d > 1.0) {
