...
public class LoggerTest {
    ...
    public void smoke() {
        ...
        final Logger logger = lc.getLogger(LoggerTest.class);
    ...
    public void testNoStart() {
        ...
        final List<Status> statusList = lc.getStatusManager().getCopyOfStatusList();
    ...
    public void testRootLogger() {
        ...
        assertEquals("Return logger isn't named root", logger.getName(), org.slf4j.Logger.ROOT_LOGGER_NAME);
    ...
    void checkLevelThreshold(final Logger logger, final Level threshold) {
    ...
    public void innerClass_I() {
        ...
        final Logger a_b = lc.getLogger("a$b");
    ...
    public void innerClass_II() {
        root.setLevel(Level.DEBUG);
        final Logger a = lc.getLogger(this.getClass());
        a.setLevel(Level.INFO);
        final Logger a_b = lc.getLogger(new Inner().getClass());
        assertEquals(Level.INFO, a_b.getEffectiveLevel());
    }
    ...
    public void setLevelToNull_LBCLASSIC_91() {
        loggerTest.setLevel(Level.DEBUG);
        final ch.qos.logback.classic.Logger child = lc.getLogger(loggerTest.getName() + ".child");
        loggerTest.setLevel(null);
        assertEquals(root.getEffectiveLevel(), loggerTest.getEffectiveLevel());
