...
public class LoggerContextDeadlockTest {
	...
	public void testLBCLASSIC_81() throws JoranException {
		...
		for (int i = 0; i < 500; i++) {
			final ByteArrayInputStream baos = new ByteArrayInputStream("<configuration><root level=\"DEBUG\"/></configuration>".getBytes());
			jc.doConfigure(baos);
		}
	}
	...
	class GetLoggerThread extends Thread {
		...
		GetLoggerThread(final LoggerContext loggerContext) {
