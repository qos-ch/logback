...
public class FelixHost {
    ...
    public FelixHost(final FrameworkErrorListener frameworkErrorListener, final CheckingBundleListener myBundleListener) {
    ...
    public void doLaunch() {
        ...
        final Map<String, Object> configMap = new StringMap();
        ...
        try {
            ...
            final BundleContext felixBudleContext = felix.getBundleContext();
