...
public class JMXConfigurator extends ContextAwareBase implements JMXConfiguratorMBean, LoggerContextListener {
    ...
    private boolean previouslyRegisteredListenerWithSameObjectName() {
        final List<LoggerContextListener> lcll = loggerContext.getCopyOfListenerList();
    ...
    public List<String> getLoggerList() {
        ...
        final Iterator<Logger> it = lc.getLoggerList().iterator();
        while (it.hasNext()) {
            final Logger log = it.next();
    ...
    public List<String> getStatuses() {
        ...
        final Iterator<Status> it = context.getStatusManager().getCopyOfStatusList().iterator();
        while (it.hasNext()) {
