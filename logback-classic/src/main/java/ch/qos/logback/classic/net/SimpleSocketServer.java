...
public class SimpleSocketServer extends Thread {
	...
	private final List<SocketNode> socketNodeList = new ArrayList<>();
	...
	public void run() {
		...
		try {
			...
			while (!closed) {
				...
				final SocketNode newSocketNode = new SocketNode(this, socket, lc);
	...
	static public void configureLC(final LoggerContext lc, final String configFile) throws JoranException {
